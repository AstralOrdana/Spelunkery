...
public class RopeLadderBlockItem extends BlockItem {
    ...
    public void appendHoverText(ItemStack stack, @javax.annotation.Nullable Level level, List<Component> tooltip, TooltipFlag context) {
        ...
        if (Screen.hasShiftDown()) {
            tooltip.add(Component.translatable("tooltip.underground_overhaul.rope_ladder_1").setStyle(Style.EMPTY.applyFormat(ChatFormatting.GRAY)));
            tooltip.add(Component.translatable("tooltip.underground_overhaul.rope_ladder_2").setStyle(Style.EMPTY.applyFormat(ChatFormatting.GRAY)));
            tooltip.add(Component.translatable("tooltip.underground_overhaul.rope_ladder_3").setStyle(Style.EMPTY.applyFormat(ChatFormatting.GRAY)));
        }
    }
