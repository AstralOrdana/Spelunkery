...
public class WoodenSluiceBlockEntityOld extends RandomizableContainerBlockEntity {
    private NonNullList<ItemStack> items;
    private final ContainerOpenersCounter openersCounter;
    private int cooldownTime;
    private long tickedGameTime;

    public WoodenSluiceBlockEntityOld(BlockPos blockPos, BlockState blockState) {
        ...
        this.openersCounter = new ContainerOpenersCounter() {
            ...
            protected boolean isOwnContainer(Player player) {
                if (player.containerMenu instanceof ChestMenu) {
                    ...
                    return container == WoodenSluiceBlockEntityOld.this;
                } else {
                    return false;
                }
            }
