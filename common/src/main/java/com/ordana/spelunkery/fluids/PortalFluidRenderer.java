...
public class PortalFluidRenderer extends ModFluidRenderProperties {
    ...
    public static ResourceLocation portalFluidLargeSW = Spelunkery.res("block/portal_fluid_large_sw");
    public static ResourceLocation portalFluidLargeSE = Spelunkery.res("block/portal_fluid_large_se");
    public static ResourceLocation portalFluidLargeNW = Spelunkery.res("block/portal_fluid_large_nw");
    public static ResourceLocation portalFluidLargeNE = Spelunkery.res("block/portal_fluid_large_ne");

    public static ResourceLocation portalFluidN = Spelunkery.res("block/portal_fluid_n");
    public static ResourceLocation portalFluidE = Spelunkery.res("block/portal_fluid_e");
    public static ResourceLocation portalFluidS = Spelunkery.res("block/portal_fluid_s");
    public static ResourceLocation portalFluidW = Spelunkery.res("block/portal_fluid_w");

    public static ResourceLocation portalFluidSW = Spelunkery.res("block/portal_fluid_sw");
    public static ResourceLocation portalFluidSE = Spelunkery.res("block/portal_fluid_se");
    public static ResourceLocation portalFluidNW = Spelunkery.res("block/portal_fluid_nw");
    public static ResourceLocation portalFluidNE = Spelunkery.res("block/portal_fluid_ne");

    public static ResourceLocation portalFluidNS = Spelunkery.res("block/portal_fluid_ns");
    public static ResourceLocation portalFluidEW = Spelunkery.res("block/portal_fluid_ew");

    public static ResourceLocation portalFluidWNE = Spelunkery.res("block/portal_fluid_wne");
    public static ResourceLocation portalFluidNES = Spelunkery.res("block/portal_fluid_nes");
    public static ResourceLocation portalFluidESW = Spelunkery.res("block/portal_fluid_esw");
    public static ResourceLocation portalFluidSWN = Spelunkery.res("block/portal_fluid_swn");

    public static ResourceLocation portalFluidNESW = Spelunkery.res("block/portal_fluid_nesw");
    public static ResourceLocation portalFluidNONE = Spelunkery.res("block/portal_fluid_none");
    public static ResourceLocation portalFluidUncommon = Spelunkery.res("block/portal_fluid_uncommon");
    public static ResourceLocation portalFluidRare = Spelunkery.res("block/portal_fluid_rare");

    public static ResourceLocation portalFluidSnence = Spelunkery.res("block/portal_fluid_snence");
    public static ResourceLocation portalFluidMaple = Spelunkery.res("block/portal_fluid_maple");
    ...
    public ResourceLocation getStillTexture(FluidState state, BlockAndTintGetter getter, BlockPos pos) {
        ...
        else if (getBelowBlock(pos).is(ModBlocks.MAGNETITE.get())) return portalFluidSnence;
    ...
    public TextureAtlasSprite[] getFluidSprites(@Nullable BlockAndTintGetter view, @Nullable BlockPos pos, FluidState state) {
        ...
        else if (getBelowBlock(pos).is(ModBlocks.MAGNETITE.get())) return portalFluidSpriteSnence;
        else if (isNonFluidAdjacent(pos, Direction.NORTH)) {
