...
public class BlockStripeFeatureConfig implements FeatureConfiguration {
    ...
    public static final Codec<BlockStripeFeatureConfig> CODEC = RecordCodecBuilder.create((instance) -> instance.group(
            ...
            RegistryCodecs.homogeneousList(Registry.BLOCK_REGISTRY).fieldOf("first_target").forGetter((blockStripeFeatureConfig) -> blockStripeFeatureConfig.firstTarget),
            ...
            RegistryCodecs.homogeneousList(Registry.BLOCK_REGISTRY).fieldOf("second_target").orElse(null).forGetter((blockStripeFeatureConfig) -> blockStripeFeatureConfig.secondTarget),
            ...
            RegistryCodecs.homogeneousList(Registry.BIOME_REGISTRY).fieldOf("biomes").orElse(null).forGetter((blockStripeFeatureConfig) -> blockStripeFeatureConfig.biomes),
