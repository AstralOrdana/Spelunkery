...
public class ModItems {
    ...
    public static final Supplier<Item> ROCK_SALT = regItem("rock_salt", () ->
            new BlockItem(ModBlocks.ROCK_SALT.get(), new Item.Properties().tab(getTab(CreativeModeTab.TAB_DECORATIONS))));
    ...
    public static final Supplier<Item> NEPHRITE_FOUNTAIN = regItem("nephrite_fountain", () ->
            new NephriteSpoutItem(ModBlocks.NEPHRITE_FOUNTAIN.get(), new Item.Properties().tab(getTab(CreativeModeTab.TAB_REDSTONE))));
    ...
    public static final Supplier<Item> WOODEN_CHANNEL = regItem("wooden_channel", () ->
            new ChannelItem(ModBlocks.WOODEN_CHANNEL.get(), new Item.Properties().tab(getTab(CreativeModeTab.TAB_REDSTONE))));
    public static final Supplier<Item> STONE_CHANNEL = regItem("stone_channel", () ->
            new ChannelItem(ModBlocks.STONE_CHANNEL.get(), new Item.Properties().tab(getTab(CreativeModeTab.TAB_REDSTONE))));
    public static final Supplier<Item> WOODEN_SLUICE = regItem("wooden_sluice", () ->
            new ChannelSluiceItem(ModBlocks.WOODEN_SLUICE.get(), new Item.Properties().tab(getTab(CreativeModeTab.TAB_REDSTONE))));
    public static final Supplier<Item> STONE_SLUICE = regItem("stone_sluice", () ->
            new ChannelSluiceItem(ModBlocks.STONE_SLUICE.get(), new Item.Properties().tab(getTab(CreativeModeTab.TAB_REDSTONE))));
    ...
    public static final Supplier<Item> PICK_ON_A_STICK = regItem("iron_pick_on_a_stick", () ->
            new PickOnAStickItem(new Item.Properties().tab(getTab(CreativeModeTab.TAB_TOOLS)).stacksTo(1).durability(1200)));
    ...
    public static final Supplier<Item> BUNNY_EARS = regItem("bunny_ears", () ->
            new BunnyEarsItem(new Item.Properties().tab(getTab(CreativeModeTab.TAB_TOOLS)).stacksTo(1)));
    public static final Supplier<Item> TRUE_CROWN = regItem("true_crown", () ->
            new TrueCrownItem(new Item.Properties().tab(getTab(CreativeModeTab.TAB_TOOLS)).stacksTo(1).rarity(Rarity.EPIC)));
